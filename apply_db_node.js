...
const connectionString = "postgresql://postgres:f48hYLaviOTW9lnS@db.nychzaapchxdlsffotcq.supabase.co:5432/postgres";
...
async function runSQL() {
    console.log("Connecting to Supabase PostgreSQL using Node.js connection pooler (IPv4)...");
